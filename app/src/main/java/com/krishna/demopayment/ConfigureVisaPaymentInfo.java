...
public class ConfigureVisaPaymentInfo {
    ...
    public final static String VISA_CHECKOUT_API_KEY = "NQM0LX8Z6KOB29QBT94P13l0MmCv82oEJ09fMfGhnqs7N1Jhl";

    /** OPTIONAL. Merchant Profile name if any */
    public static String VISA_CHECKOUT_PROFILE_NAME = "Krishna DEMO";
